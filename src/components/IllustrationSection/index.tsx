...
const IllustrationSection = () => {
  return (
    <div className='relative w-full min-h-[150px] overflow-y-visible overflow-x-clip mb-5 max-h-[300px]'>
      ...
      <div className='absolute bottom-0 left-0 right-0 w-[120%] h-48 object-cover z-10 pointer-events-none flex items-end justify-start'>
        <Water />
      </div>
    </div>
  );
