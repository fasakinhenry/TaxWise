    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
              ...
              <div className="flex items-center gap-3">
                {userData.isVerified ? (
                  ...
                  <>
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Unverified Account</p>
                      <p className="text-sm text-gray-500">Please verify your email address</p>
                    </div>
                  </>
                )}
              </div>
          ...
          <div className="px-8 py-6 border-b border-gray-100">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Tax Profile</h2>
            
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                Complete your tax profile to get personalized assistance and save your tax information for quick access.
              </p>
          ...
          <div className="px-8 py-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-1">Get help with your taxes</p>
              </button>
            </div>
          </div>
        </motion.div>
